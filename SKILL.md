...
```javascript
// 1. Import ResourceBundle
"sap/base/i18n/ResourceBundle"

// 2. Load in onInit()
async onInit() {
    await super.onInit();
    const sModulePath = sap.ui.require.toUrl("your/namespace");
